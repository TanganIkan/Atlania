                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                                <div class="flex flex-col order-2 md:order-1">
                                    <div class="relative w-fit mb-6 md:mb-10">
                                        ...
                                        <div class="absolute left-0 bottom-1 w-full h-[8px] md:h-[10px] bg-purple-500">
                                        </div>
                                    </div>

                                    <div
                                        class="flex items-center space-x-3 text-xs md:text-sm text-gray-400 mb-4 md:mb-6 font-medium">
                                    ...
                                    <h1
                                        class="text-3xl md:text-5xl font-bold text-[#1a1c2e] mb-4 md:mb-6 leading-[1.2] md:leading-[1.15] tracking-tight">
                                        {{ $article->title }}
                                    </h1>
                                    ...
                                    <div class="flex items-start space-x-4 md:space-x-5">
                                        ...
                                        <a href="{{ route('articles.show', $article->slug) }}"
                                            ...
                                            <svg class="w-5 h-5 md:w-6 md:h-6 transform rotate-45" fill="none"
                                ...
                                <div class="relative order-1 md:order-2">
                                    <div
                                        class="rounded-[2rem] md:rounded-[2.5rem] shadow-sm overflow-hidden aspect-video md:aspect-[4/3] bg-gray-100 flex items-center justify-center">
                                        @if ($article->image)
        ...
        <div class="mb-16">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12 gap-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto">
                    ...
                    <div
                        class="flex bg-gray-50 p-1 rounded-xl border border-gray-100 overflow-x-auto max-w-full no-scrollbar">
                        <button
                            class="whitespace-nowrap px-4 md:px-6 py-2 bg-white shadow-sm rounded-lg text-sm font-bold text-[#1a1c2e]">Technologies</button>
                        <button
                            class="whitespace-nowrap px-4 md:px-6 py-2 text-sm font-bold text-gray-400 hover:text-[#1a1c2e] transition">Health</button>
                        <button
                            class="whitespace-nowrap px-4 md:px-6 py-2 text-sm font-bold text-gray-400 hover:text-[#1a1c2e] transition">Business</button>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($popularArticles as $article)
                    <div
                        class="group cursor-pointer p-4 md:p-5 transition-all duration-300 rounded-[2rem] md:rounded-[2.5rem] hover:bg-white hover:shadow-xl hover:shadow-gray-100">
                        <div
                            class="relative aspect-[4/3] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden mb-4 md:mb-6 shadow-sm bg-gray-200 flex items-center justify-center">
                            @if ($article->image)
                        ...
                        <h3
                            class="text-lg md:text-xl font-extrabold text-[#1a1c2e] leading-snug mb-2 group-hover:text-orange-600 transition-colors line-clamp-2">
                            {{ $article->title }}
                        </h3>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                            <div
                                class="flex items-center space-x-3 md:space-x-4 text-[10px] md:text-[11px] font-bold text-gray-400">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10">
                @foreach ($articles->take(1) as $article)
                    <div class="lg:col-span-7 group cursor-pointer">
                        <div
                            class="relative aspect-video rounded-[1.5rem] md:rounded-[2rem] overflow-hidden mb-6 md:mb-8 shadow-sm">
                        ...
                        <a href="{{ route('articles.show', $article->slug) }}" class="block">
                            <h3
                                class="text-2xl md:text-3xl font-extrabold text-[#1a1c2e] leading-tight mb-4 group-hover:text-orange-600 transition-colors">
                                {{ $article->title }}
                            </h3>
                        </a>
                ...
                <div class="lg:col-span-5 space-y-6 md:space-y-8">
                    @foreach ($articles->skip(1)->take(3) as $article)
                        <a href="{{ route('articles.show', $article->slug) }}"
                            class="flex items-start space-x-4 md:space-x-6 group">
                            <div class="flex-shrink-0 w-24 h-24 md:w-32 md:h-32 rounded-2xl overflow-hidden shadow-sm">
                                ...
                                @else
                                    <div
                                        class="w-full h-full bg-gray-200 flex items-center justify-center text-[10px] text-gray-400 font-bold">
                                        No Image</div>
                                @endif
                            </div>
                            <div class="flex-1">
                                ...
                                <h4
                                    class="text-sm md:text-base font-extrabold text-[#1a1c2e] leading-snug mb-2 group-hover:text-orange-600 transition-colors line-clamp-2">
                                    {{ $article->title }}
                                </h4>
                        ...
                        @foreach ($articles as $article)
                            <div class="swiper-slide h-auto w-[85%] sm:w-[45%] lg:w-[30%]">
                                <div
                                    ...
                                    <div
                                        class="relative aspect-[4/3] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden mb-6 shadow-sm">
                                        @if ($article->image)
                                            <img src="{{ $article->image }}" alt="{{ $article->title }}"
                                                class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                        @else
                                    ...
                                    <div class="flex items-center justify-between pt-5 border-t border-gray-50">
                                        <div
                                            ...
                                            <span
                                                class="hidden sm:flex items-center hover:text-orange-500 transition-colors cursor-pointer">
                                        ...
                                        <a href="{{ route('articles.show', $article->slug) }}"
                                            ...
                                            <svg class="w-4 h-4 md:w-5 md:h-5 transform rotate-45" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                                    d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                            </svg>
