        ...
        <main class="max-w-7xl mx-auto px-6 py-16">
            ...
            <div class="mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 px-4">
                ...
                <a href="{{ route('articles.create') }}"
                    class="bg-[#f15a24] text-white px-8 py-4 rounded-2xl font-black text-xs shadow-2xl shadow-orange-200 hover:scale-105 active:scale-95 transition-all uppercase tracking-widest">
                    + Buat Postingan Baru
                </a>
            </div>
