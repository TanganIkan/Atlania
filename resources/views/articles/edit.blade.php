...
@section('content')
    <main class="max-w-6xl mx-auto px-4 py-12 font-['Plus_Jakarta_Sans']">
        <div class="mb-10">
            <h1 class="text-2xl font-bold text-[#1a1c2e] uppercase tracking-tight">Edit Article</h1>
            <p class="text-sm text-gray-400">Update your ideas and inspirations today.</p>
        </div>
        ...
        <form method="POST" action="{{ route('articles.update', $article->id) }}" enctype="multipart/form-data" id="article-form"
            ...
            <div
                ...
                <div id="placeholder-text" class="text-center {{ $article->image ? 'hidden' : '' }}">
                    ...
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Click to change image</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="title" value="{{ old('title', $article->title) }}" required placeholder="Enter title..."
