...
class Article extends Model
{
    ...
    public function getImageAttribute($value)
    {
        ...
        return asset('images/default-thumbnail.jpg'); // Saran: beri default image
    }
    ...
    /**
     * Ambil artikel terpopuler berdasarkan periode
     */
    public static function getPopularByPeriod($period)
    {
        ...
        match ($period) {
            ...
            default => $query->whereDate('article_views.view_date', today()), // Perbaikan di sini
        };
